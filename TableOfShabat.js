        ...
        return (
            <View key={this.props.shabat._id} style={{ margin: 5, flex: 1, alignSelf: 'stretch', flexDirection: 'column' }}>
                <View style={{ flex: 1, alignSelf: 'stretch', paddingBottom: 5 }}>
                    <Text onPress={() => this.props.shabat.parasha.includes("פרשת") ? Linking.openURL('https://he.wikipedia.org/wiki/' + this.props.shabat.parasha.replace(" ", "_")) : Alert.alert("ניתן לקבל מידע רק עבור פרשות")} style={styles.ParashaTitle}>
