export default class Shabat {
  ...
  Beer_Sheva_in = "";
  Beer_Sheva_out = "";
  constructor(_id, date, hebDate, parasha, Jerusalem_in, Jerusalem_out, Tel_Aviv_in, Tel_Aviv_out, Hayfa_in, Hayfa_out, Beer_Sheva_in, Beer_Sheva_out) {
    this._id = _id;
    ...
    else if (parasha.includes('א\' דסוכות') || parasha.includes('א\' דפסח') || parasha.includes('שביעי של פסח') || parasha.includes('שמיני') || parasha.includes('שבועות'))
